...
public class ContratanteRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!editNome.getText().toString().equals("")&&!completeEstado.getText().toString().equals("")&&
                    ...
                    Toast.makeText(ContratanteRegistrationActivity.this, "Preencha o campo nome!", Toast.LENGTH_SHORT).show();
                }
                    ...
                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    btn_next.setEnabled(true);
                    Toast.makeText(ContratanteRegistrationActivity.this, "Preencha o campo estado!", Toast.LENGTH_SHORT).show();
                }
                    ...
                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    btn_next.setEnabled(true);
                    Toast.makeText(ContratanteRegistrationActivity.this, "Preencha o campo cidade!", Toast.LENGTH_SHORT).show();
                }
                    ...
                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    btn_next.setEnabled(true);
                    Toast.makeText(ContratanteRegistrationActivity.this, "Preencha o campo telefone!", Toast.LENGTH_SHORT).show();
                }
                    ...
                    getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                    btn_next.setEnabled(true);
                    Toast.makeText(ContratanteRegistrationActivity.this, "Escolha ou tire uma foto!", Toast.LENGTH_SHORT).show();
                }
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int permissionCheck = ContextCompat.checkSelfPermission(ContratanteRegistrationActivity.this,
                        Manifest.permission.CAMERA);
                if (permissionCheck== PackageManager.PERMISSION_GRANTED) {
                    dispatchTakePictureIntent();
                }
                else {
                    ActivityCompat.requestPermissions(ContratanteRegistrationActivity.this,
        ...
        try {
            ...
            if (hasPerm == PackageManager.PERMISSION_GRANTED) {
                ...
                android.support.v7.app.AlertDialog.Builder builder =
                        new android.support.v7.app.AlertDialog.Builder(ContratanteRegistrationActivity.this);
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putString("img_contratante",picturePath);
        outState.putString("estado",completeEstado.getText().toString());
        outState.putString("cidade",completeCidade.getText().toString());
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState!=null){
            ...
            picturePath=savedInstanceState.getString("img_contratante");
            completeEstado.setText(savedInstanceState.getString("estado"));
            completeCidade.setText(savedInstanceState.getString("cidade"));
