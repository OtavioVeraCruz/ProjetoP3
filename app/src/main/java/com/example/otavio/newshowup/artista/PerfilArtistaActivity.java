...
public class PerfilArtistaActivity extends AppCompatActivity {
    ...
    @BindView(R.id.editYoutube)EditText editYoutube;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nome= SnapshotArtista.getArtista().nome;
        String youtube="";
       if (SnapshotArtista.getArtista().youtube_channel!=null){
           youtube=SnapshotArtista.getArtista().youtube_channel;
       }
        String cidade_artista=SnapshotArtista.getArtista().dadosArtista.cidade;
        String telefone=SnapshotArtista.getArtista().dadosArtista.telefone;
        String estado=SnapshotArtista.getArtista().dadosArtista.estado;
        String url=SnapshotArtista.getArtista().foto;

        editNome.setText(nome);
        editEstado.setText(estado);
        autoCompleteTextView.setText(cidade_artista);
        editTelefone.setText(telefone);
        editYoutube.setText(youtube);
        LoadImg.loadImage(url,img_artista,this);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!editNome.getText().toString().equals("")&&!autoCompleteTextView.getText().toString().equals("")&&
                    ...
                    if (picturePath==null){
                        picturePath=SnapshotArtista.getArtista().foto;
                    }
                    ...
                    Firebase.Artista artista=new Firebase.Artista(SnapshotArtista.getId_artista(),editNome.getText()
                            .toString(),picturePath,dadosArtista,SnapshotArtista.getArtista().token,
                            Firebase.getmAuth().getCurrentUser().getUid(),editYoutube.getText().toString(),SnapshotArtista.getArtista()
                            .candidaturas);
                    Firebase.updateArtista(artista,new Runnable(){
                        @Override
                        public void run() {
                            Intent i=new Intent(PerfilArtistaActivity.this, HomeArtistaActivity.class);
                            startActivity(i);
                        }
                    });
                    ...
                    Toast.makeText(PerfilArtistaActivity.this, "Preencha o campo nome!", Toast.LENGTH_SHORT).show();
                }
                else if(editEstado.getText().toString().equals("")){
                    Toast.makeText(PerfilArtistaActivity.this, "Preencha o campo estado!", Toast.LENGTH_SHORT).show();
                }
                else if(autoCompleteTextView.getText().toString().equals("")){
                    Toast.makeText(PerfilArtistaActivity.this, "Preencha o campo cidade!", Toast.LENGTH_SHORT).show();
                }
                else if(editTelefone.getText().toString().equals("")){
                    Toast.makeText(PerfilArtistaActivity.this, "Preencha o campo telefone!", Toast.LENGTH_SHORT).show();
                }

                else if (genero[0].equals(ArrayString.generos[0])){
                    Toast.makeText(PerfilArtistaActivity.this, "Escolha um gênero da lista!", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(PerfilArtistaActivity.this, "Escolha uma faixa de preço da lista!", Toast.LENGTH_SHORT).show();
                }
        ...
        img_artista.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int permissionCheck = ContextCompat.checkSelfPermission(PerfilArtistaActivity.this,
                        Manifest.permission.CAMERA);
                if (permissionCheck== PackageManager.PERMISSION_GRANTED) {
                    dispatchTakePictureIntent();
                }
                else {
                    ActivityCompat.requestPermissions(PerfilArtistaActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_PICK_PICTURE && resultCode == RESULT_OK && null != data) {
            ...
            if (exif != null)
                orientation = exif.getAttributeInt(android.support.media.ExifInterface.TAG_ORIENTATION,
        ...
        try {
            ...
            if (hasPerm == PackageManager.PERMISSION_GRANTED) {
                ...
                android.support.v7.app.AlertDialog.Builder builder =
                        new android.support.v7.app.AlertDialog.Builder(PerfilArtistaActivity.this);
