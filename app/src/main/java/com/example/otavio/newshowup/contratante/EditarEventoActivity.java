...
public class EditarEventoActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Carrega imgs
        for (int i=0;i<imgs_adress.size();i++){
            LoadImg.loadImage(evento.fotos.get(i),imgs.get(i),this);
        }
        imgs.get(0).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int permissionCheck = ContextCompat.checkSelfPermission(EditarEventoActivity.this,
                ...
                if (permissionCheck== PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(EditarEventoActivity.this,
        ...
        btn_edit_event.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Firebase.Evento evento1=new Firebase.Evento(evento.id,evento.id_contratante,nome_event,desc,
                        instrum,faixa_preco[0],imgs_adress,city,date,evento.candidatos);
        ...
        try {
            ...
            if (hasPerm == PackageManager.PERMISSION_GRANTED) {
                ...
                android.support.v7.app.AlertDialog.Builder builder =
                        new android.support.v7.app.AlertDialog.Builder(EditarEventoActivity.this);
